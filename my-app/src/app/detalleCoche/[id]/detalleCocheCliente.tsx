...
export default function DetalleCocheCliente({ auto }: Props) {
  ...
  const [mostrarSolicitudResercva, setMostrarModalSolicitud] =
    useState(false);
          ...
          <div className="flex flex-col lg:flex-row gap-8 w-full">
            ...
            <div className="flex-1 min-w-[450px] max-w-full">
              ...
              <div className="bg-white mt-5">
                <h3 className="text-[#11295B] text-xl font-semibold">
                  Detalles
                </h3>
                ...
                <h4 className="text-[#11295B] text-lg font-semibold mt-4">
                  Descripción
                </h4>
